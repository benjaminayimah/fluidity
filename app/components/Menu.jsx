...
const Menu = ({handleToggle, menuIsActive }) => {
    ...
    return (
        <>
        <aside className={`${menuIsActive ? 'menu-open' : 'menu-close'}`}>
            {/* Menu */}
        ...
        <div onClick={handleToggle} className={`overlay ${menuIsActive ? 'show-overlay' : ''}`}/>
        </>
    )
}
